...
def add_new_last_layer(base_model, nb_classes):
  ...
  x = Dense(FC_SIZE, activation='relu', W_regularizer=regularizers.l2(0.01), b_regularizer=regularizers.l2(0.01))(x) #new FC layer, random init
...
def train(args, arch):
  ...
  if arch == 'vgg19':
      ...
      checkpoint = ModelCheckpoint("models/{}vgg19.model".format(filepath, monitor=['val_acc', 'val_loss'], verbose=1, save_best_only=True, mode='max'))
      ...
      filepath = "with_val_{val_acc:.4f}_{val_loss:.4f}_{epoch:02d}_"
