...
def train(args):
  ...
  checkpoint = ModelCheckpoint("models/t6_{}inres2.model".format(filepath, monitor=['val_acc', 'val_loss'], verbose=1, save_best_only=True, mode='max'))
...
if __name__=="__main__":
  ...
  a.add_argument("--train_dir", default="Task6/train_dir/")
