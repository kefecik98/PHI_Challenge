...
"""  test_datagen = ImageDataGenerator(
  ...
  # transfer learning
  	...
  	filepath = "CNNiV3_{epoch:02d}_{val_acc:.3f}"
  	checkpoint = ModelCheckpoint("models/t8b8i{}.model".format(filepath, monitor='acc', verbose=1, save_best_only=True, mode='max'))
...
if __name__=="__main__":
  ...
  a.add_argument("--output_model_file", default="inceptionv3t8l.model")
